    ...
    <div className="min-h-screen bg-green-50 p-4 sm:p-6 lg:p-8 font-sans">
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-green-600 font-medium sm:text-base">
              Manage dental supplies
            </p>
          </div>
          <button
            onClick={handleAddItem}
            className="inline-flex items-center justify-center gap-2 cursor-pointer px-5 py-2 bg-green-600 text-white text-base font-medium rounded-lg hover:bg-green-700 hover:scale-105 transition-all duration-300 shadow-sm"
          >
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatsCard
            title="Total Value"
            value={`LKR ${stats.totalValue.toLocaleString(undefined, {
