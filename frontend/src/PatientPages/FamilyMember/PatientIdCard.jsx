      ...
      >
        <div className="border-2 border-cyan-500 bg-white rounded-2xl  w-[50%] p-11" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex flex-row justify-end gap-10 pb-4">
            ...
            <div>
              <button className=" p-2 bg-white border-2 border-cyan-400 rounded-xl text-cyan-600 text-lg hover:bg-cyan-100 hover:text-black">
                <div className="flex flex-row justify-evenly gap-x-0.5">
                  <div>
                    <Printer />
                  </div>
          ...
          <div className="border-2 rounded-lg border-cyan-600 shadow-2xl  flex  flex-col justify-center w-full  md:w-[90%]  mx-auto">
            ...
            <div className="flex flex-row justify-evenly">
              <div className="pl-4">
                ...
                <h1 className="text-cyan-800">{User.date}</h1>
                <h1 className="text-cyan-400">Email Address</h1>
                <h1 className="text-cyan-800">{User.email}</h1>
              </div>
              <div
