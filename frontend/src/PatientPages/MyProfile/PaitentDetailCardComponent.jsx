...
const PaitentDetailCardComponent = ({ type, name, value, onChange }) => {
  return (
    <div className="flex flex-col p-2">
      <label className="font-light text-cyan-600">{name}</label>
      <input
        type={type}
        name={name}
        value={value || ""}  // If no value is passed, default to empty string
        onChange={onChange}
