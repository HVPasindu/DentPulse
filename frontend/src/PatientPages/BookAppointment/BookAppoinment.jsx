...
//           "http://localhost:8080/api/v1/patient/list", // replace with your backend API endpoint
//           {
//             headers: {
...
//     if (selectedPatient) {
//       setSelectDate(date);
//       fetchAvailableTimes(date); // Fetch available times after date selection
//       console.log("Date is successfully selected!", date);
//     } else {
//       alert("Select a Patient First!");
//     }
...
//       const token = localStorage.getItem("authToken");
//       const response = await axios.get(
//         `http://localhost:8080/api/v1/appointments/booked-times?date=${date}`, // replace with your backend API endpoint
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
//         }
//       );
//       setAvailableTimes(response.data); // Set the booked times
//     } catch (error) {
...
//             selectedPatient={selectedPatient}
//             selectDate={selectDate}
//             availableTimes={availableTimes} // Passing the available times to TimeSlot component
//           />
//         </div>
//       </div>
//     </div>
...
// export const BookAppoinment = () => {
//   const [FamilyDetail, setFamilyDetail] = useState([]);
//   const [bookedTimes, setBookedTimes] = useState([]); // Changed from availableTimes to bookedTimes
//   const [appointment, setAppointments] = useState({
//     id: "apt_001",
//     patientId: "owner_001",
//     patientName: "John Doe",
...
//     if (selectedPatient) {
//       setSelectDate(date);
//       fetchBookedTimes(date); // Fetch booked times after date selection
//     } else {
//       alert("Select a Patient First!");
//     }
//   };
...
//       setBookedTimes(response.data); // Set the booked times
//     } catch (error) {
//       console.error("Failed to fetch booked times:", error);
//       setBookedTimes([]); // Reset to empty array on error
//     }
//   };
...
//         formattedDate = selectDate.toISOString().split('T')[0];
//       }
