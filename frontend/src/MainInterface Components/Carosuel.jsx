...
function Carosuel() {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const transformed = data.slice(0, 10).map((review) => ({
        id: review.reviewId,
  ...
  if (cards.length === 0) {
    return (
      <div className="bg-green-600 flex justify-center items-center h-64 text-white">
        Loading reviews...
      </div>
    );
  }
    ...
    <div className=" bg-green-600 flex items-center justify-center p-4 md:p-8 overflow-x-hidden">
      <div className="w-full max-w-7xl">
        <div className="mb-8 flex flex-col justify-center items-center">
          ...
          <p className="text-green-200 font-2xl">
