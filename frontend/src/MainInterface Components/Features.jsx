...
export const Features = () => {
  return (
    <div className="">
      {" "}
      <div className="bg-linear-to-r from-green-500 via-green-600 to-green-700 text-lg px-4 py-20 text-white font-bold grid grid-cols-1 gap-y-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
