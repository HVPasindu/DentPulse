    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 md:p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 px-4 md:px-6 py-4 md:py-6 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-primary-500 rounded-lg transition-colors cursor-pointer"
          >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-t-2 border-gray-300 pt-3 mt-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xl md:text-2xl font-bold text-primary-600">${totalCost}</span>
                      </div>
                    </div>
                  </div>
                ) : (
        ...
        <div className="border-t border-gray-200 px-4 md:px-6 py-4 bg-gray-50">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-2.5 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors font-medium cursor-pointer"
          >
            Close
          </button>
        </div>
